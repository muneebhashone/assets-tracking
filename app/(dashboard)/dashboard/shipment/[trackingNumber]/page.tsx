...
export default async function Component(props: PageProps) {
    const { params } = props
    const shipData: ShipmentData = await getShipmentByTrackingNumber(params.trackingNumber as string) as ShipmentData
    ...
    return (
        <div className="flex flex-col h-screen">
            <header className="flex items-center h-14 border-b px-4 md:h-16 bg-gray-100/40 dark:bg-gray-800/40">
                <Link href={'/dashboard'}>
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-6">
                <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2">
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-semibold">{shipData?.tracking_number}</div>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader>
                        ...
                        <CardContent>
                            <div className="text-2xl font-semibold">{shipData?.arrivalTime}</div>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader>
                ...
                <div className="flex items-center h-14 border-b px-4 md:h-16 bg-gray-100/40 dark:bg-gray-800/40 mt-2 mb-2">
                    ...
                    <h1 className="text-lg font-semibold md:text-2xl">Vessel Details</h1>
                    <div className="ml-auto flex items-center gap-2 md:gap-4">

                    </div>
                </div>
                <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2">
                    {shipData?.vessels && shipData?.vessels?.map((vessel, index) => {
                        return (
                            < Card key={index}>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <div className="grid gap-2">
                                        ...
                                        <div className="flex justify-between">
                                            <div className="text-gray-500 dark:text-gray-400">Flag:</div>
