          ...
          <>
            <Card className="w-[350px]">
              ...
              <CardFooter className="flex justify-between">
                <Link
                  className="border rounded-md px-4 py-2 transition-colors bg-[#D3991F] text-primary-foreground shadow hover:bg-primary/90"
                  href={`/dashboard/shipment/${ship.tracking_number}`}
                >
                  Details
                </Link>
              </CardFooter>
