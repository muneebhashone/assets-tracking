  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6 ">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight mb-5 animate-in fade-in slide-in-from-top-5 duration-500">
          {isFetching ? (
            "Loading..."
          ) : (
            <div>
              <span className=" bg-black bg-clip-text">Welcome back, </span>
              <span className="text-blue-500">{currentUser?.user.name}!</span>
            </div>
          )}
        </h2>
      </div>
